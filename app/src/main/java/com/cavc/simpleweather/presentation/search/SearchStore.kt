...
import com.cavc.simpleweather.domain.usecase.ChangeFavouriteStateUseCase
import com.cavc.simpleweather.domain.usecase.SearchCityUseCase
import com.cavc.simpleweather.presentation.search.SearchStore.Intent
import com.cavc.simpleweather.presentation.search.SearchStore.Label
import com.cavc.simpleweather.presentation.search.SearchStore.State
...
class SearchStoreFactory @Inject constructor(
    ...
    fun create(reasonOpening: ReasonOpening): SearchStore =
        object : SearchStore, Store<Intent, State, Label> by storeFactory.create(
            ...
            executorFactory = { ExecutorImpl(reasonOpening) },
            reducer = ReducerImpl
        ) {}
    ...
    private inner class ExecutorImpl(
        private val reasonOpening: ReasonOpening
